...
export interface SceneSettingsV1 { version: 1; distanceMethod: DistanceMethod; allowOutOfBounds?: boolean }
export const DEFAULT_SCENE_SETTINGS: SceneSettingsV1 = { version: 1, distanceMethod: "scene", allowOutOfBounds: false };
...
export function parseSceneSettings(value: unknown): SceneSettingsV1 {
  ...
  return candidate.version === 1 && METHODS.has(distanceMethod as DistanceMethod) && (candidate.allowOutOfBounds === undefined || typeof candidate.allowOutOfBounds === "boolean")
    ? { version: 1, distanceMethod: distanceMethod as DistanceMethod, allowOutOfBounds: candidate.allowOutOfBounds === true }
