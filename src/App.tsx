...
export default function App() {
  ...
  useEffect(() => {
    ...
    void Promise.all([clearEmitterLabels(), clearDetectorLabels()]);
  }, [connection.sceneReady]);

  useEffect(() => () => { void clearEmitterLabels(); void clearDetectorLabels(); }, []);
