...
const effectDefaultName = (effect: EffectDefinitionV1) => effect.type === "shader" ? effect.preset === "beam" ? "Directional beam" : "Glow" : effect.type === "mechanical" ? effect.action === "face" ? "Face" : "Hide/Show" : effect.type === "light" ? effect.action === "add" ? "Add Light" : "Modify Light" : INTEGRATION_CATALOG.find((provider) => provider.id === effect.providerId)?.displayName ?? "Integration effect";
const effectTypeLabel = (effect: EffectDefinitionV1) => effect.type === "shader" ? effect.preset : effect.type === "mechanical" ? effect.action === "face" ? "Face" : "Hide/Show" : effect.type === "light" ? effect.action === "add" ? "Add Light" : "Modify Light" : INTEGRATION_CATALOG.find((provider) => provider.id === effect.providerId)?.displayName ?? effect.providerId;
