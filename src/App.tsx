...
export const newRule = (): DetectionRuleV1 => ({ id: crypto.randomUUID(), enabled: true, signal: "", detectionArea: "distance", aggregation: "nearest", ignoreHidden: false, matchType: "exact", excludeLayers: [], range: { outer: 60, inner: 0 }, falloff: "smoothstep", effects: [newEffect()] });
